...
/**
   ...
   *
   * Requires these environment variables to be set (do NOT hardcode secrets here):
   *   TWILIO_ACCOUNT_SID
   *   TWILIO_AUTH_TOKEN
   */
...
if (!TWILIO_ACCOUNT_SID || !TWILIO_AUTH_TOKEN) {
    console.error('❌ Missing required env vars: TWILIO_ACCOUNT_SID and/or TWILIO_AUTH_TOKEN.');
    console.error('   Set them before running, e.g.:');
    console.error('   TWILIO_ACCOUNT_SID=xxx TWILIO_AUTH_TOKEN=yyy node setup-webhook.js');
    process.exit(1);
}
